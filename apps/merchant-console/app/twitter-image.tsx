...
export const alt = "SELLABLE — Agentic Commerce Platform";
export const size = {
  width: 1200,
  height: 630,
};
      ...
      >
        ...
        >
          <div style={{ display: "flex", alignItems: "center", gap: 12 }}>
            ...
            >
              <div style={{ width: 10, height: 10, borderRadius: 2, background: "#080808" }} />
            </div>
            <span
              style={{
                fontSize: 13,
        ...
        >
          ...
          >
            AI buyers discover, negotiate, and pay — with deterministic policy.
          </div>
        </div>
