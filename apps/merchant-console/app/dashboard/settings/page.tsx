...
import { Save, RefreshCw, Check, AlertCircle, ArrowRight } from "lucide-react";
import {
  getConsolePolicy,
  updateConsolePolicy,
...
export default function SettingsPage() {
  ...
  return (
    <div className="p-6 space-y-6">
      <PageHeader
        title="Settings"
        subtitle="MERCHANT-CONTROLLED BOUNDARIES"
        actions={
          <>
      ...
      {loading ? (
        ...
        <>
          ...
          <Section title="STORE" hint="MERCHANT IDENTITY · READ-ONLY + CATEGORIES">
            <div className="py-2 border-b border-[var(--bb-line-soft)]">
            ...
            <div className="py-2 border-b border-[var(--bb-line-soft)]">
              <div className="font-[var(--font-mono)] text-[0.5rem] uppercase text-[var(--bb-grey-4)] mb-1">Currency</div>
              <div className="font-[var(--font-mono)] text-[0.85rem] text-[var(--bb-white)]">{current.currency}</div>
            </div>
            <div className="pt-3">
          ...
          <Section title="SELLING" hint={hasChanges ? "UNSAVED CHANGES" : "FULL EDITOR IN SELLING RULES"}>
            {sellingFields.map((field) => {
              ...
              return (
                <div key={field.key} className="py-3 flex items-center justify-between gap-3 border-b border-[var(--bb-line-soft)] last:border-b-0">
                  <span className={`font-[var(--font-mono)] text-[0.6rem] tracking-[0.12em] uppercase ${field.highlight ? "text-[var(--bb-orange)]" : "text-[var(--bb-grey-3)]"}`}>{field.label}</span>
            ...
            <Link href="/dashboard/selling-rules" className="mt-3 inline-flex items-center gap-1.5 font-[var(--font-mono)] text-[0.6rem] tracking-[0.1em] uppercase text-[var(--bb-orange)] hover:text-[var(--bb-orange-bright)] transition-colors">
              OPEN FULL SELLING RULES + SIMULATOR <ArrowRight size={11} />
            </Link>
            <div className="mt-3 font-[var(--font-sans)] text-[0.75rem] text-[var(--bb-grey-2)] leading-relaxed">
          ...
          <Section title="PAYMENTS" hint="READ FROM BACKEND /agents/status">
            {statusError ? (
              <span className="font-[var(--font-mono)] text-[0.6rem] text-amber-400">Backend unreachable while fetching status.</span>
            ) : (
              <>
                ...
                {status?.payment_rail.webhook_last_verified_at && (
                  <div className="mt-2 font-[var(--font-mono)] text-[0.55rem] text-[var(--bb-grey-3)]">
                ...
                <Link href="/dashboard/payments" className="mt-3 inline-flex items-center gap-1.5 font-[var(--font-mono)] text-[0.6rem] tracking-[0.1em] uppercase text-[var(--bb-orange)] hover:text-[var(--bb-orange-bright)] transition-colors">
                  OPEN PAYMENT RECORDS <ArrowRight size={11} />
                </Link>
              </>
            )}
          </Section>
          ...
          <Section title="AI" hint="PROVIDER SUBSTITUTABLE WITHOUT TOUCHING COMMERCE">
            {statusError ? (
              ...
              <>
                ...
                <div className="grid grid-cols-1 sm:grid-cols-3 gap-4 mt-3 pt-3 border-t border-[var(--bb-line-soft)]">
                  <div>
                  ...
                  <div>
                    ...
                    <div className="flex items-center gap-2">
                      ...
                      <span className={`font-[var(--font-mono)] text-[0.7rem] ${llmMeta.color}`}>{llmMeta.text}</span>
                    </div>
                    {status?.llm.reason && (
                ...
                <div className="mt-3 font-[var(--font-sans)] text-[0.7rem] text-[var(--bb-grey-3)] leading-relaxed">
          ...
          <Section title="DEVELOPER" hint="KEYS · DISCOVERY · ENDPOINTS">
            ...
            <Link href="/dashboard/developers" className="inline-flex items-center gap-1.5 font-[var(--font-mono)] text-[0.6rem] tracking-[0.1em] uppercase text-[var(--bb-orange)] hover:text-[var(--bb-orange-bright)] transition-colors">
              OPEN DEVELOPERS <ArrowRight size={11} />
            </Link>
          </Section>
        </>
      )}
