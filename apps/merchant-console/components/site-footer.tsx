...
const footerColumns: FooterColumn[] = [
  ...
  },
  {
    ...
    links: [
      ...
      { label: "Contact", href: "mailto:hello@sellable.shop" },
      ...
      <div className="page-frame relative">
        ...
        <div className="footer-bottom">
          ...
          <div className="footer-bottom-links">
            ...
            <a
              href="https://api.sellable.shop/health"
              target="_blank"
              rel="noopener noreferrer"
              className="footer-bottom-link hover:text-[var(--bb-white)]"
              title="GET /health"
            ...
            <a href="mailto:hello@sellable.shop" className="footer-bottom-link hover:text-[var(--bb-white)]">
              hello@sellable.shop
            </a>
          </div>
